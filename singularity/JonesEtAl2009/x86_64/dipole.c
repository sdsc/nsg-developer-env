...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 dipole /home/ubuntu/test/JonesEtAl2009/x86_64/dipole.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/ubuntu/test/JonesEtAl2009/mod_files/dipole.mod";
static const char* nmodl_file_text = 
  "NEURON {\n"
  "SUFFIX dipole\n"
